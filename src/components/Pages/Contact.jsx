...
const Contact = () => {
  ...
  // Event handler for form field changes
    ...
    <div>
        ...
        <section className="page-section" >
            <div>
                ...
                <div id="contactSection2">
                    <div className="contactList list-unstyled">
        ...
        <p>If you're interested in <span>working with me</span> or <span>have any questions,</span> please don't hesitate to contact me. </p>
        <p>I will be pleased to receive your <span>message</span>! </p>
        <div className='form'>
